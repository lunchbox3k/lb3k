...
def email_notification_for(restaurant_arrived_name):
    ...
    while status != 200 and attempt <= 6:
        ...
        try:
            ...
            result2 = requests.post("https://api.mailgun.net/v3/sandbox92d50346bad74139acc91c33ac2c50b3.mailgun.org/messages", auth=("api", "key-42e3d9f10b9b041a11918b0aa7dd620d"), data={"from": "LunchBox3000@hotlunch.com", "to": "hspitzle@gmail.com", "subject": subject_val, "text": "STFU.GG.GTFO"})
