...
def email_notification_for(restaurant_arrived_name):
    ...
    while status != 200 and attempt <= 6:
        ...
        try:
            ...
            result2 = requests.post("https://api.mailgun.net/v3/pretos.com/messages", auth=("api", "key-42e3d9f10b9b041a11918b0aa7dd620d"), data={"from": "LunchBox3000@pretos.com", "to": ["9898591371@txt.att.net","mr.mcnoot@gmail.com"], "subject": subject_val, "text": "lunch"})
